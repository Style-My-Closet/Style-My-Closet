...
public record AttributeTimeCursorStrategy(
    DateTimePath<Instant> path,
    Function<String, Instant> parser,
    Function<ClothesAttributeDefinition, Instant> extractor
) implements CursorStrategy<Instant, ClothesAttributeDefinition> {
  ...
  @Override
  public Instant extract(ClothesAttributeDefinition instance) {
    if (instance == null) {
